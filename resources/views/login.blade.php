                ...
                <div class="auth-wrapper auth-cover">
                    <div class="auth-inner row m-0">
                        <!-- Brand logo--><a class="brand-logo" href="index.html">
                            ...
                            <h2 class="brand-text text-primary ms-1">Grievance Portal</h2>
                        </a>
                        <!-- /Brand logo-->
                        <!-- Left Text-->
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Welcome to NAAC! 👋</h2>
                                ...
                                <p class="text-center mt-2"><span>New on our platform?</span><a
                                        href="{{ route('registeration') }}"><span>&nbsp;Create an account</span></a></p>
                                ...
                                <div class="auth-footer-btn d-flex justify-content-center"><a class="btn btn-facebook"
                                        ...
                                        {{-- <button class="btn btn-success"><a href="{{ route('registeration') }}">Register Account</a></button> --}}
                            </div>
                        </div>
                        <!-- /Login-->
                    </div>
