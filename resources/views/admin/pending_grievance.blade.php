@extends('layout.main', ['breadcrumb_title' => 'Pending Grievance'])
@section('title', 'Grievance::Pending')
@section('content')
 {{-- @can('role_create') --}}
<div class="row">
    <div class="col-lg-12">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Pending Grievance</h4>
                        </div><!-- end card header -->
                        <div class="card-body">
